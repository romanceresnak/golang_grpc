...
type Memory struct {
	...
	Unit                 Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=grpc.roman.Memory_Unit" json:"unit,omitempty"`
...
func init() {
	proto.RegisterEnum("grpc.roman.Memory_Unit", Memory_Unit_name, Memory_Unit_value)
	proto.RegisterType((*Memory)(nil), "grpc.roman.Memory")
}
...
var fileDescriptor_c0c7f919ccc765da = []byte{
	...
	0x17, 0xe2, 0x4a, 0x2f, 0x2a, 0x48, 0xd6, 0x2b, 0xca, 0xcf, 0x4d, 0xcc, 0x53, 0x5a, 0xcd, 0xc8,
	...
	0x9e, 0x50, 0x1e, 0x2b, 0x88, 0x17, 0xe2, 0x1a, 0x04, 0xe1, 0xb1, 0x39, 0xb1, 0x44, 0x31, 0x15,
	0x24, 0x25, 0xb1, 0x81, 0xbd, 0x61, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x0f, 0xf5, 0x93, 0x44,
	0xde, 0x00, 0x00, 0x00,
}
